...
import EditCourse from '../ProfessorCourses/EditCourse.js';
...
describe("CreateModule creates a module", () => {
    it("should render a module creation page and create a text module", async () => {
        ...
        const wrapper = mount(<EditCourse database={fakeDatabase}/>)
        await wrapInAct(wrapper);


        expect(getInnerHTML(wrapper.find('.courseHeader').first())).toEqual("Courses:")
